    ...
    <>
      <S.Wrapper>
        <S.PicturesContainer>
          ...
          >
            <S.ContoursWrapper>
              <PreloadImage shouldContain imageSrc={frameSrc as string} alt="" />
            </S.ContoursWrapper>
          </MouseParallax>
          <MouseParallax
            isAbsolutelyPositioned
          ...
          >
            <S.Shape1Wrapper>
              <PreloadImage shouldContain imageSrc={shape1Src as string} alt="" />
            </S.Shape1Wrapper>
          </MouseParallax>
          ...
          >
            <S.Shape2Wrapper>
              <PreloadImage shouldContain imageSrc={shape2Src as string} alt="" />
            </S.Shape2Wrapper>
          </MouseParallax>
          ...
          >
            <S.Shape3Wrapper>
              <PreloadImage shouldContain imageSrc={shape3Src as string} alt="" />
            </S.Shape3Wrapper>
          </MouseParallax>
          ...
          >
            <S.Shape4Wrapper>
              <PreloadImage shouldContain imageSrc={shape4Src as string} alt="" />
            </S.Shape4Wrapper>
          </MouseParallax>
          ...
          >
            <S.Shape5Wrapper>
              <PreloadImage shouldContain imageSrc={shape5Src as string} alt="" />
            </S.Shape5Wrapper>
          </MouseParallax>
          ...
          >
            <S.Shape6Wrapper>
              <PreloadImage shouldContain imageSrc={shape6Src as string} alt="" />
            </S.Shape6Wrapper>
          </MouseParallax>
          ...
          >
            <S.Shape7Wrapper>
              <PreloadImage shouldContain imageSrc={shape7Src as string} alt="" />
            </S.Shape7Wrapper>
          </MouseParallax>
          ...
          >
            <S.Shape8Wrapper>
              <PreloadImage shouldContain imageSrc={shape8Src as string} alt="" />
            </S.Shape8Wrapper>
          </MouseParallax>
          ...
          >
            <S.Shape9Wrapper>
              <PreloadImage shouldContain imageSrc={shape9Src as string} alt="" />
            </S.Shape9Wrapper>
          </MouseParallax>
        </S.PicturesContainer>
      </S.Wrapper>
